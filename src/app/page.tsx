            ...
            <section className="w-screen h-screen overflow-hidden bg-gradient-to-b from-[#024343] to-[#001212] ">
                ...
                >
                    ...
                    <motion.section
                        ...
                        <h1 className={`${taviraj.className} font-[500] italic text-[38px] text-[#ffe9a6] leading-[120%] text-center`}>
                            Congratulation!
                        </h1>

                        <p className={`${taviraj.className} font-[400] leading-[30px] text-[28px] text-white max-w-[326px] text-center`}>
