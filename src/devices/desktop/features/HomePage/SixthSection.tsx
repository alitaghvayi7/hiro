...
import ImageSix from "@/assets/images/introduction/image6-lg.png";
    ...
    return (
        <>
            <ClientMotionComponent
                step={step}
                value={6}
                className={`w-full !h-[calc(100vh-92px)] relative isolate overflow-hidden bg-transparent flex items-center justify-around`}>
