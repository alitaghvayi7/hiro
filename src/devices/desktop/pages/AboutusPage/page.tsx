...
function AboutusPage() {
    return (
        <RootLayout>
            <section className="w-full !h-[calc(100vh-92px)] bg-transparent overflow-hidden relative isolate hidden lg:flex items-center justify-center">
                <section className={`w-full max-w-[1190px] h-full mx-auto relative isolate overflow-hidden overflow-y-auto bg-transparent flex items-center justify-around`}>
